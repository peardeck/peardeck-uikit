...
const StyledCallToActionImageContainer = styled.div`
  ...
  padding: 1em;
`;
export const CallToAction = ({ children, title, image, buttonContent }) =>
  React.createElement(
    StyledCallToAction,
    null,
    React.createElement(
      ...
      null,
      React.createElement(StyledCallToActionContentHeader, null, title),
      React.createElement(StyledCallToActionContent, null, children),
      React.createElement(Button, null, buttonContent)
    ),
    React.createElement(StyledCallToActionImageContainer, null, image)
  );
