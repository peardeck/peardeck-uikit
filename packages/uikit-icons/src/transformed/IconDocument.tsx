...
const SvgIconDocument = ({
  ...
  <svg viewBox="0 0 64 64" width={size} height={size} {...props}>
    ...
    <path d="M45 26H20c-1.1 0-2-.9-2-2s.9-2 2-2h25c1.1 0 2 .9 2 2s-.9 2-2 2zm0 10H20c-1.1 0-2-.9-2-2s.9-2 2-2h25c1.1 0 2 .9 2 2s-.9 2-2 2zm0 10H20c-1.1 0-2-.9-2-2s.9-2 2-2h25c1.1 0 2 .9 2 2s-.9 2-2 2z" />
  </svg>
);
