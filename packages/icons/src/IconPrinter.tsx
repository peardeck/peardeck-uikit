...
const SvgIconPrinter = ({ title, size, ...props }: SvgIconProps) => (
  <svg viewBox="0 0 250 244.6" width={size} height={size} {...props}>
    ...
    <path
      className="icon-printer_svg__a"
      d="M250 48.2h-30.93V11a11 11 0 0 0-11-11H49.93a11 11 0 0 0-11 11v37.2H0v138h34.93v47.4a11 11 0 0 0 11 11h158.14a11 11 0 0 0 11-11v-47.38H250zM60.93 22h136.14v26.2H60.93zm132.14 200.6H56.93V137h136.14z"
    />
  </svg>
);
