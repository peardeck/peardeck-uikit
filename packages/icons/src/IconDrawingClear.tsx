...
const SvgIconDrawingClear = ({ title, size, ...props }: SvgIconProps) => (
  <svg viewBox="0 0 52.7 62.2" width={size} height={size} {...props}>
    ...
    <path d="M17.5 29.2c-1.7.1-2.9 1.5-2.8 3.1l.9 16.8c.1 1.6 1.4 2.8 3 2.8h.2c1.7-.1 2.9-1.5 2.8-3.1l-1-16.8c-.1-1.6-1.5-2.9-3.1-2.8zM35.9 29.2c-1.6-.1-3.1 1.2-3.1 2.8l-.9 16.8c-.1 1.7 1.2 3.1 2.8 3.1h.2c1.6 0 2.9-1.2 3-2.8l.9-16.8c0-1.6-1.2-3-2.9-3.1zM26.7 29.9c-1.7 0-3 1.3-3 3v15.4c0 1.7 1.3 3 3 3s3-1.3 3-3V32.9c0-1.7-1.4-3-3-3z" />
  </svg>
);
