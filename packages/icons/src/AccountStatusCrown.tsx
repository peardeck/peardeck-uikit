...
const SvgAccountStatusCrown = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 59.42 41.19" width="1em" height="1em" {...props}>
    ...
    <path
      d="M53.91 33.7a18.43 18.43 0 0 1-7 2.51c-4.76.88-12 1-22-2s-16-7.19-19.45-10.57a18.62 18.62 0 0 1-4.43-6l-1 3.2a18.42 18.42 0 0 0 4.43 6c3.47 3.38 9.44 7.52 19.45 10.56s17.28 2.93 22 2a18.52 18.52 0 0 0 7-2.52z"
      fill="#e0cb4b"
    />
  </svg>
);
