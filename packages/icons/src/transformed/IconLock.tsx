...
const SvgIconLock = ({ title, size, ...props }: SvgIconProps): JSX.Element => (
  <svg viewBox="0 0 64 64" width={size} height={size} {...props}>
    ...
    <path
      d="M16.6 205.5v-2.9c0-5.3-4.3-9.6-9.6-9.6s-9.6 4.3-9.6 9.6v2.9h-1.3c-.7 0-1.3.5-1.3 1.2v16.9c0 .7.5 1.3 1.2 1.3h21.9c.7 0 1.3-.5 1.3-1.2v-16.9c0-.7-.5-1.3-1.2-1.3h-1.4z"
